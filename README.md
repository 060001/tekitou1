...
# マッチ内のユーザー情報
- ピックして、マッチスタート後info項目に行き、All Player infoを押して待つ
- 匿名プレイヤーの名前表示とともに、ほかの情報なども表示(敵プレイヤーも可能)

---

### 免責事項
本ツールは教育目的で作成されたものです。  
本ツールの使用によって生じたいかなる問題（アカウントのBAN等を含む）についても、開発者は一切の責任を負いません。使用は自己責任でお願いいたします。
